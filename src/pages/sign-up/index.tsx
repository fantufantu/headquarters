...
const SignIn = () => {
      ...
      await _signUp({
        variables: {
          registerBy: {
            ...
            emailAddress: _formValues.emailAddress ?? "",
            password: _formValues.password ?? "",
            captcha: _formValues.captcha ?? "",
          },
        },
      }).catch(() => null)
    )?.data?.register;
  ...
  const { invalid: isEmailAddressInvalid } = form.getFieldState(
    "emailAddress",
    form.formState
  );
          ...
          <section className="mt-28">
            ...
            <Form className="mt-10" form={form}>
              ...
              >
                ...
                <Countdown
                  disabled={!emailAddress || isEmailAddressInvalid}
                  onClick={sendCaptcha}
                >
                  GET CAPTCHA
                </Countdown>
